...
function newFullajtarGame(){
    if (interval === undefined || interval <= 0){
        ...
        document.getElementById('startfullajtar').textContent = 'Reštart';
    }
...
let sec = 0; // prevzate z : https://stackoverflow.com/questions/5517597/plain-count-up-timer-in-javascript
